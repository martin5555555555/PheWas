...
sbatch --job-name="$JOB_NAME" \
        ...
        --output="$OUTPUT_FILE" \
        --error="$ERROR_FILE" \
        --wrap="/gpfs/commons/home/mstoll/anaconda3/envs/phewas/bin/python /gpfs/commons/groups/gursoy_lab/mstoll/codes/models/data_form/calcul_distance_matrix.py"
