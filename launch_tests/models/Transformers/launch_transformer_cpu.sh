...
sbatch --job-name="$JOB_NAME" \
        ...
        --output="$OUTPUT_FILE" \
        --error="$ERROR_FILE" \
        --wrap="/gpfs/commons/home/mstoll/anaconda3/envs/phewas/bin/python /gpfs/commons/groups/gursoy_lab/mstoll/codes/Data_Files/Training/SNPS/generate_data_snp.py"
